             ...
             children : <Widget>[
              ...
              RaisedButton(
                ...
                child: Container(
                  ...
                  child:
                      const Text('Generate a password', style: TextStyle(fontSize: 30)),
                ),
              ),
              ...
              Padding(
                ...
                Align(
                    ...
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => TodoApp()))
                  )
                  ),
  ...
  Widget build(BuildContext context) {
    return new GestureDetector(
      child: new Tooltip(preferBelow: false,
          message: "Copy", child: new Text("$password")),
      onTap: () {
